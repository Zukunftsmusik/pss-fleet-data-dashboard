...
from app.models.error import ErrorConverter, ErrorOut
...
def get_default_responses(*status_codes: int) -> dict[int, dict[str, Any]]:
    ...
    status_codes = tuple([status_code for status_code in status_codes if status_code in all_codes])
...
def get_default_responses_for_get(
    include_204: bool = False, description_204: str | None = None, include_404: bool = False, description_404: str | None = None
